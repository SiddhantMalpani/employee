<?php
 ...
 $query="SELECT emp_name,emp_department,emp_salary FROM login WHERE emp_department <> 'Administration'";
 ...
 if(isset($_POST['upd'])){
    ...
    <strong>Enter!</strong> a valid Amount.
