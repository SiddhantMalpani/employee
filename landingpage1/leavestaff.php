...
<body>
    ...
    <body>
        ...
        <main class="d-flex flex-nowrap ">
            ...
            <div class="flex-shrink-0 p-3 sidebarheight heightside" style="width: 250px; background-color: rgb(55, 55, 115);">
                ...
                <ul class="list-unstyled ps-0">
                    ...
                    <li class="mb-1">
                        <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed text-white link-body-emphasis" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
                            Dashboard
                        </button>
                    ...
                    <li class="mb-1">
                        <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed text-white link-body-emphasis" data-bs-toggle="collapse" data-bs-target="#orders-collapse" aria-expanded="false">
                            Salary
                        </button>
                        <div class="collapse" id="orders-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded text-white">View
                                        Salary</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="mb-1">
                        <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed text-white link-body-emphasis" data-bs-toggle="collapse" data-bs-target="#leave-collapse" aria-expanded="false">
                            Leave
                        </button>
                        <div class="collapse" id="leave-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded text-white">Apply
                                        Leave</a></li>
                                <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded text-white">View
                                        Leave</a></li>
                            </ul>
            ...
            <div class="main">
                ...
                <div class="footer"> <i class="fa-regular fa-copyright copyright-icon"></i> &nbsp;<p class="copyright-text">
