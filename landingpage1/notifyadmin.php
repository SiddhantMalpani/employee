...
if(isset($_POST['notif'])){
   ...
   VALUES (NULL,'$_SESSION[employeename]','$department','admin','$details')";
   $data1= mysqli_query($conn,$query1);
        ...
        <main class="d-flex flex-nowrap ">
            ...
            <div class="main">
                ...
                <div class="main-content">
                    <div class="top">
                        <div class="dashboard">
                            <h2> <b>NOTIFY ADMIN</b> </h2>
                        </div>
                        <div class="home-icon">
                        <i class="fa-solid fa-house home-icon2 "></i>
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb margin fontsize">
                                <li class="breadcrumb-item"><a href="/landingpage1/page2.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">NOTIFY ADMIN</li>
                            </ol>
                        </nav>
                    </div>
                </div>
         ...
         <form class="frm" method="POST">
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <button type="submit" value="Register" name="notif" class="btn btn-primary btn-lg"
              style="padding-left: 2.5rem; padding-right: 2.5rem;">NOTIFY</button>
          </div>
        </form>
      </div>
